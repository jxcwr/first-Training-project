  ...
  <div class="user_details">
    ...
    <div class="info">
      <el-form label-width="100" size="small">
        ...
        <el-form-item label="注册时间"> {{user.register_time |fmtDate }} </el-form-item>
    ...
    <!-- 个人信息模态框 -->
    <el-dialog title="个人信息修改" :visible.sync="visible" width="50%" @close="clearValidate" class="customer_modal">
    ...
    <el-dialog title="更改头像" :visible.sync="visible_userface" width="50%"  class="customer_modal">
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" size="small" @click="alterUserfaceHandler">确定修改</el-button>
      </span>
    </el-dialog>
    <!-- /个人信息模态框 -->
  </div>
...
export default {
  ...
  methods: {
    ...
    // 更改头像
    toAlterUserface(){
      this.userface = this.user.user_face;
    ...
    alterUserfaceHandler(){
      let data = Object.assign({},_.clone(this.user),{user_face:this.userface})
